...
public class main {
	...
	public static double[] main(String filename) {
...
/*		
	...
	*/	
        ...
        double[] final_result = new double[7];
        for (int i = 0; i < result.length; i++)
        	final_result[i] = result[i];
        for (int i = result.length; i < result.length + fitting.length; i++)
        	final_result[i] = fitting[i - result.length];
